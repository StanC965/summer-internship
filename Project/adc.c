/**
 * @file adc.c
 * @brief Implementation of the Analog-to-Digital Converter (ADC) functions and ISR handler.
 */
...
/** @brief Stores the latest calculated and inverted result updated by the ADC ISR */
 ...
 * @details Automatically calculates the inverted ambient light scale value upon conversion completion.
 */
