/**
 * @file scheduler.c
 * @brief Implementation of non-preemptive periodic task scheduler[cite: 9, 13].
 */
...
/** @name Scheduler Task Flag Bit Positions */
/**@{*/
...
/** @brief Active status bitmask for pending tasks[cite: 9, 13] */
...
{
    /** @brief Preserved tick counter keeping track of timing intervals */
