...
- **512** — **System Tick**. Choose a timer that will be dedicated to construct the system tick, e.g. TC0 or TC1. Set the timer for interrupts at 10ms precise interval. ATTENTION! in order for you to obtain the most accurate 10ms interval you have to research what is the best setup. So, play around with:
...
- **522** — Go to Ambient Light Application and refactor the code as follows:
