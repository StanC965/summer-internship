...
- **711** — **CORE** —  [Understanding Serial Protocols - YouTube](https://www.youtube.com/watch?v=LEz5UCN3aHA)
- **712** — **CORE** —  [Understanding UART - YouTube](https://www.youtube.com/watch?v=sTHckUyxwp8)
- **713** — **STRETCH** —  [PROTOCOLS: UART - I2C - SPI - Serial communications #001 - YouTube](https://www.youtube.com/watch?v=IyGwvGzrqp8)
- **714** — **STRETCH** —  [UART (Universal Asynchronous Receiver Transmitter) - Basics - YouTube](https://www.youtube.com/watch?v=npL5ph9RG84)
- **715** — **STRETCH** —  [UART - Troubleshooting tips (Debugging UART issues) - YouTube](https://www.youtube.com/watch?v=r-N53fpaJWo)
- **716** — **STRETCH** —  [Tutorials for the AVR Microcontroller : UART](https://www.youtube.com/watch?v=e8uEKWpVf10)
- **717** — **STRETCH** —  **FOR YOUR INFORMATION:** RS-232 is a very similar serial protocol to UART (it is similar because in its simplest form has the same hardware connections and uses the UART frame definition, but voltage levels are very different). It is used today mainly for industrial applications. Also your PC could still have the DB9 connector for RS-232.
