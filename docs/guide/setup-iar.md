...
![Open IAR product page](../assets/images/iar/iar-install-step-1.png)

1. Scroll to supported architectures and choose AVR.

![Choose AVR architecture](../assets/images/iar/iar-install-step-2.png)

1. Continue until you reach the trial version section and choose the trial download flow.

![Find trial version section](../assets/images/iar/iar-install-step-3.png)

1. During installation and first run, choose to register for an evaluation license.

![Register for evaluation license](../assets/images/iar/iar-install-step-4.png)

1. On the evaluation registration page, choose the code-size-limited 4K option.

![Select 4K code-size evaluation license](../assets/images/iar/iar-install-step-5.png)
